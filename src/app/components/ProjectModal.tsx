    ...
    <AnimatePresence initial={false}>
      {project && (
        <>
          ...
          >
          <motion.div
            className="relative w-full md:w-[99%] xl:w-[55%] max-h-[90vh] md:max-h-[99vh] xl:max-h-[90vh] bg-white rounded-[16px] overflow-y-auto cursor-none pointer-events-auto modal-scrollbar"
