...
export const projects: Project[] = [
  {
    ...
    title: "Padronização e consistência visual através do redesign",
    titleEn: "Redesign Physical Tracking",
    category: "Fully, All Easy consultoria · 2026",
    tags: ["UI Design", "Redesign", "Mobile", "Usability Testing"],
    size: "normal",
    video: "/img/physical/physical-showcase.mp4",
    blocks: [
      { type: "label", text: "Fully, All Easy consultoria · 2026" },
  ...
  },
  {
    ...
    title: "Diminuindo a carga cognitiva em um ambiente sobrecarregado",
    titleEn: "Access Control",
    category: "Product Design",
    tags: ["UX Design", "UI Design", "Field Research", "Shadowing"],
    size: "wide",
    video: "/img/desk-showcase.mp4",
    blocks: [
      { type: "label", text: "Controle de acesso condominial, desk apepê · 2026" },
  ...
  },
  {
    id: 3,
    slug: "apepe-cadastro",
    title: "Simplificando processo de cadastro",
    titleEn: "apepê · Sign-up",
    category: "app condomínial, apepê · 2023",
    tags: ["UI Design", "Usability Testing", "Mobile"],
    size: "wide",
    video: "/img/project-1/thumbnail.mp4",
    blocks: [
      { type: "label", text: "app condomínial, apepê · 2023" },
  ...
  },
  {
    ...
    tags: ["Rive", "Motion Design", "Mobile", "UI Design"],
    size: "normal",
