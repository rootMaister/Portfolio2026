...
export const projects: Project[] = [
  {
    ...
    size: "wide",
    video: "src\\app\\components\\img\\desk-showcase.mp4",
    blocks: [
      ...
      { type: "image", src: "src/app/components/img/controle-de-acesso/Image.jpg", alt: "Interface de software concorrente observada em campo", caption: "Interface de software concorrente observada durante a pesquisa de campo" },
      { type: "divider" },
      { type: "heading", text: "Transformando campo em solução", size: "sm" },
      { type: "image", src: "src/app/components/img/controle-de-acesso/Image-1.jpg", alt: "Diagrama de fluxo do Controle de Acesso", caption: "Mapeamento dos fluxos por perfil de usuário" },
      { type: "divider" },
      ...
      { type: "image", src: "src/app/components/img/controle-de-acesso/Image-2.jpg", alt: "Wireframes no quadro branco", caption: "Ideação inicial de interface no quadro branco" },
      { type: "divider" },
      { type: "heading", text: "Protótipo", size: "sm" },
      { type: "image", src: "src/app/components/img/controle-de-acesso/Image-3.jpg", alt: "Protótipo de alta fidelidade do Controle de Acesso", caption: "Protótipo de alta fidelidade — Histórico de Acesso" },
      { type: "image", src: "src/app/components/img/controle-de-acesso/Frame 857.jpg", alt: "Histórico de acesso com modal de seleção de visitante", caption: "Fluxo de registro de acesso — seleção de visitante cadastrado" },
      { type: "image", src: "src/app/components/img/controle-de-acesso/Frame 864.jpg", alt: "Formulário de cadastro de novo visitante", caption: "Formulário de cadastro de novo visitante" },
      { type: "divider" },
  ...
  },
  {
    ...
    category: "Product Design",
    size: "wide",
    video: "src\\app\\components\\img\\project-1\\thumbnail.mp4",
    banner: "src/app/components/img/project-1/banner_project.jpg",
    blocks: [
  ...
  },
  {
    ...
    category: "Product Design",
    size: "normal",
    video: "src\\app\\components\\img\\physical-showcase.mp4",
    blocks: [
